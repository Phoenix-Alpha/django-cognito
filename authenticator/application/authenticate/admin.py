...
class CognitoAdmin(admin.AdminSite):
    ...
    site_title = _('django-cognito Admin')
    site_header = _('django-cognito Administration')
    index_title = _('django-cognitoLogin')
...
adminsite = CognitoAdmin(name='django-cognito-cognito_admin')
    ...
    def save_model(self, request, obj, form, change):
        ...
        try:
            ...
            if not change:
                ...
                # username acts django-cognito5@test.com as a email
